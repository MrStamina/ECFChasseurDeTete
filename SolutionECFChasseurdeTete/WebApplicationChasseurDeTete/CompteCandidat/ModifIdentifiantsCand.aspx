<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ModifIdentifiantsCand.aspx.cs" Inherits="WebApplicationChasseurDeTete.WebForm10" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Panel   ID="Panel2" runat="server" GroupingText="Informations de connexion">
            ...
            <asp:TextBox CssClass="TextBox" ID="TextBoxConfirmCand" TextMode="Password" runat="server"></asp:TextBox>
                 ...
                 <asp:CompareValidator  ID="CompareValidator2" runat="server" ForeColor="Red" Text="*" ErrorMessage="Le mot de passe doit être identique" ControlToValidate="TextBoxConfirmCand" ControlToCompare="TextBoxMdpCand" ></asp:CompareValidator>                         
        </p>
     
    
          <div class="Bouton">
         <asp:Button ID="ButtonValider" OnClick="ButtonValider_Click" runat="server"  Text="Valider" CssClass="btn btn-primary btn-lg"   />
                <asp:Button ID="ButtonCancel" PostBackUrl="~/CompteCandidat/EspaceCandidat.aspx" runat="server" Text="Annuler" CssClass="btn btn-primary btn-lg"  CausesValidation="false"/>
              </div>
